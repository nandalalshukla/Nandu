...
const Resume = () => {
  return (
    <div className="relative inline-flex w-fit group z-50">
      ...
      <div
        className="absolute top-full mt-2 left-0 md:left-1/2 md:-translate-x-1/2
        opacity-0 scale-95 
        group-hover:opacity-100 group-hover:scale-100 
        group-focus-within:opacity-100 group-focus-within:scale-100
        transition-all duration-300 
        w-[85vw] max-w-72 md:max-w-96 h-auto bg-card border-4 border-gray-200 dark:border-gray-600 rounded-xl overflow-hidden
        shadow-md z-50
