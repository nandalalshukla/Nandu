...
const CanvaIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
      fill="#7D2AE7"
      d="M50 100c27.614 0 50-22.387 50-50 0-27.615-22.386-50-50-50S0 22.384 0 50c0 27.613 22.386 50 50 50"
    />
    <path
      fill="url(#a)"
      d="M50 100c27.614 0 50-22.387 50-50 0-27.615-22.386-50-50-50S0 22.384 0 50c0 27.613 22.386 50 50 50"
    ...
    <defs>
      <radialGradient
        ...
        cy="0"
        r="1"
        gradientTransform="rotate(-49.416 105.972 23.325)scale(77.3416)"
      ...
      <radialGradient
        ...
        cy="0"
        r="1"
        gradientTransform="rotate(54.703 2.249 31.273)scale(87.2168)"
        gradientUnits="userSpaceOnUse"
      >
      ...
      <radialGradient
        ...
        cy="0"
        r="1"
        gradientTransform="matrix(53.84252 -54.21027 24.93201 24.76288 19.315 88.63)"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#6420FF" />
        <stop offset="1" stopColor="#6420FF" stopOpacity="0" />
      ...
      <radialGradient
        ...
        cy="0"
        r="1"
        gradientTransform="rotate(66.52 10.177 37.912)scale(78.7295 131.889)"
        gradientUnits="userSpaceOnUse"
      >
